          ...
          {stages.map((s, i) => {
            ...
            return (
              <div key={s.key}>
                ...
                >
                  {/* 68 px mieści najdłuższy skrót etapu („RETENCJA"); przy 54 px
                      wychodził poza swoją kolumnę. Stała szerokość zostaje,
                      bo to ona ustawia skróty w jednej osi. */}
                  <span className="w-[68px] shrink-0 text-right font-mono text-[11px] font-extrabold" style={{ color: fill }}>
                    {s.short}
                  </span>
                  {/*
                  ...
                  <span className="min-w-0 flex-1">
                    {/* Nazwa etapu zawija zamiast kończyć się wielokropkiem:
                        przy 360 px ucinało nawet 178 px tekstu, czyli całą
                        informację o tym, czego dany etap dotyczy. */}
                ...
                {isOpen && (
                  /*
                   * Wcięcie równa się szerokości kolumny skrótu (68 px) plus
                   * odstęp (12 px), więc panel zaczyna się pod nazwą etapu.
                   * Na wąskim ekranie wcięcie znika — zabierało tam przestrzeń
                   * potrzebną treści.
                   */
                  <div className="mb-1.5 mr-1 rounded-[8px] bg-slate-50 px-4 py-3 sm:ml-[80px]">
